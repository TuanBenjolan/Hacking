...
def login():
    ...
    try:
        ...
        id = raw_input('\x1b[1;91m[+] \x1b[1;36mEmail FB \x1b[1;91m:\x1b[1;92m ')
            ...
            if zedd == '2':
                ...
                if zedd == '3':
                    ...
                    if zedd == '4':
                        ...
                        if zedd == '5':
                            os.system('rm -rf login.txt')
                            os.system('xdg-open https://www.youtube.com/MR.054')
                            keluar()
                        else:
                            if zedd == '0':
                                keluar()
...
def mini():
    ...
    try:
        ...
        print logo
        print 40 * '\x1b[1;97m\xe2\x95\x90'
        print '\x1b[1;91m[ INFO ] Akun target harus berteman dengan akun kamu dulu !'
        try:
