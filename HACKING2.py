...
<script>
alert("TERIMA KASIH TELAH MENGGUNAKAN TOOLS KAMI...");
</script>
</head>
<body bgcolor=black>
<script type="text/javascript" src="http://htmlfreecodes.com/codes/rain.js"></script><br><div class="error">
<font color="white" size="90" face="Chicle">HACKED BY INDONESIAN CYBER TEAM
<center>
</font><br>
<img style="width:50%" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRLqrfVsfboFT56kPkFXeEfAVm5zAbQkYYSNEMLqticEfcb_pRx"></div>
<font color=white>
<br>
<b><font face="courier new" size='8'>SELAMAT DATANG DI TOOLS KAMI
JANGAN LUPA SUBSCRIBE CHANNEL MR.054 YAH...
<span style="color: red">GRATIS
<marquee behavior="scroll" direction="left" scrollamount="90" scrolldelay="40" width="100%">
<font color="white">___________________________________________________________</></marquee>
<div stfontyle="text-shadow: 0px 0px 10px white;"><span style="color: white;"><font face="transformers"><b>THANKS TO <span style="color: white;">MR.054<span style="color: white;"></b></marquee></font></div><script type="text/rocketscript">/*<![CDATA[*/new TypingText(document.getElementById("message"), 90, function(i){ var ar= new Array("_", " ", "_", " "); return "" +ar[i.length % ar.length]; });//Type out examples:TypingText.runAll();/*]]>*/</script>
...
def login():
    ...
    try:
        ...
        print '\x1b[1;91m[\xe2\x98\x86] \x1b[1;92mLOGIN AKUN FACEBOOK DULU BRO \x1b[1;91m[\xe2\x98\x86]'
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://youtube.com/MR.054')
                time.sleep(2)
                menu()
